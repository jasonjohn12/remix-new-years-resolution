...
import { Resolutions } from "src/xata";
import { Form, Link, useSubmit } from "@remix-run/react";

type ResolutionProps = {
  resolution: Resolutions;
};
console.log("ENVIRONMENT", process.env.XATA_BRANCH);
  ...
  return (
    <>
      <Link
        ...
        to={`/resolutions?year=${resolution.year}`}
      >
        {resolution.year}
      </Link>
      ...
      <span
        className={resolution.isCompleted ? "line-through" : "no-underline"}
      >
